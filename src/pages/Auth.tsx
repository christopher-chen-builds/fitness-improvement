    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground max-w-md mx-auto">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xs text-primary font-semibold tracking-wider mt-1">AI TRAINER</p>
        </div>
        ...
        <div className="w-full space-y-6">
          ...
          <form
            onSubmit={mode === "login" ? handleEmailLogin : mode === "signup" ? handleEmailSignup : handleForgotPassword}
            className="space-y-4"
          >
            {mode === "signup" && (
          ...
          {mode !== "forgot" && (
            <>
              ...
              <Button
                ...
                disabled={loading}
                className="w-full border-border text-foreground py-5 rounded-xl font-medium gap-2"
              >
